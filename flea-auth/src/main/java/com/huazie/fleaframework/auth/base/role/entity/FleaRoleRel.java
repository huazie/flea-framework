...
public class FleaRoleRel extends FleaEntity {
     ...
     * @since 2.0.0
     */
    public FleaRoleRel(Long roleId, Long relId, String relType, String remarks, String relExtA, String relExtB, String relExtC, String relExtX, String relExtY, String relExtZ) {
        this.roleId = roleId;
        this.relId = relId;
    ...
    public void setRoleRelId(Long roleRelId) {

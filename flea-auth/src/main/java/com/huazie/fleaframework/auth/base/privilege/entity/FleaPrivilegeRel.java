...
public class FleaPrivilegeRel extends FleaEntity {
    ...
    private static final long serialVersionUID = 6345859690574599888L;

    @Id
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "FLEA_PRIVILEGE_REL_GENERATOR")
    @TableGenerator(
        // 唯一的生成器名称，可以由一个或多个类引用以作为id值的生成器。
        name = "FLEA_PRIVILEGE_REL_GENERATOR",
        // 存储生成的ID值的表的名称
        ...
        pkColumnValue = "pk_flea_privilege_rel",
        // 从ID生成器表中分配ID号时增加的数量
        allocationSize = 1
    )
     ...
     * @since 1.0.0
     */
    public FleaPrivilegeRel(Long privilegeId, Long relId, String relType, String remarks, String relExtA, String relExtB, String relExtC, String relExtX, String relExtY, String relExtZ) {

...
import com.huazie.fleaframework.tools.code.FleaCodePanel;
import com.huazie.fleaframework.tools.i18n.FleaI18NPanel;
import com.huazie.fleaframework.tools.log.FleaLoggerPanel;
...
public class FleaTools extends JFrame implements ActionListener, ChangeListener, ItemListener {
    ...
    private void initMainArea() {
        FleaI18NPanel mFleaI18NPanel = new FleaI18NPanel();
        FleaCodePanel mFleaCodePanel = new FleaCodePanel();
        JScrollPane mJScrollPane = new JScrollPane(mFleaCodePanel); // 滚动条

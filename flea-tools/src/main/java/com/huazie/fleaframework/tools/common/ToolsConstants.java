...
public interface ToolsConstants {
    ...
    interface CodeConstants {
        ...
        String IS_SELECTED_DAO_IMPL = "IS_SELECTED_DAO_IMPL";
        String IS_SELECTED_DAO_INTERFACE = "IS_SELECTED_DAO_INTERFACE";
        String IS_SELECTED_ENTITY = "IS_SELECTED_ENTITY";
        String IS_SELECTED_SV_IMPL = "IS_SELECTED_SV_IMPL";
        String IS_SELECTED_SV_INTERFACE = "IS_SELECTED_SV_INTERFACE";
        String IS_SELECTED_CUSTOM_TRANSACTIONAL = "IS_SELECTED_CUSTOM_TRANSACTIONAL";

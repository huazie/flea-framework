...
public class FleaUserGroupRel extends FleaEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "FLEA_USER_GROUP_REL_SEQ")
    @SequenceGenerator(name = "FLEA_USER_GROUP_REL_SEQ")

 ...
 */
@Entity
@Table(name = "flea_operation_attr")
public class FleaOperationAttr extends FleaEntity {

    private static final long serialVersionUID = -3607641484478896279L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "FLEA_OPERATION_ATTR_SEQ")
    @SequenceGenerator(name = "FLEA_OPERATION_ATTR_SEQ")

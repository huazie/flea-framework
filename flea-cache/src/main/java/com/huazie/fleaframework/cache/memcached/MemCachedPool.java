...
public class MemCachedPool {
    ...
    public void initialize(List<CacheServer> cacheServerList) {
        ...
        if (ObjectUtils.isEmpty(initConnParam) || StringUtils.isBlank(initConnParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_INITCONN + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(minConnParam) || StringUtils.isBlank(minConnParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_MINCONN + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(maxConnParam) || StringUtils.isBlank(maxConnParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_MAXCONN + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(maintSleepParam) || StringUtils.isBlank(maintSleepParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_MAINTSLEEP + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(nagleParam) || StringUtils.isBlank(nagleParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_NAGLE + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(socketTOParam) || StringUtils.isBlank(socketTOParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_SOCKETTO + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(socketConnectTOParam) || StringUtils.isBlank(socketConnectTOParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_SOCKETCONNECTTO + " ></cache-param>】未配置或配置值为空");
        }
        ...
        if (ObjectUtils.isEmpty(hashingAlgParam) || StringUtils.isBlank(hashingAlgParam.getValue())) {
            throw new FleaCacheException("请检查flea-cache-config.xml配置,【<cache-param key=" + CacheConstants.MemCachedConfigConstants.MEMCACHED_CONFIG_HASHINGALG + " ></cache-param>】未配置或配置值为空");
        }
